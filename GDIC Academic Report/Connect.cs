...
namespace GDIC_Academic_Report
{
    class Connect
    {
        ...
        //Provider=Microsoft.ACE.MySql.12.0;Data Source=C:\Users\mujahid41\Desktop\mahfuz\mahfuz_result\mahfuz_result\bin\Debug\DATA\RESULT_DB.accdb
        ...
        public MySqlDataReader readdata(string str)
        {
            if (con.State != ConnectionState.Open)
            {
                con.Open();
        ...
        //public  string cstr = @"Provider=Microsoft.ACE.MySql.12.0;Data Source=D:\C#\C# _MJ_project\ss_acc\ss_acc\sunshine1.accdb";
